...
class ProjectDetailView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['team'] = User.objects.filter(application__project_id=self.kwargs['pk'], application__status=Application.StatusValues.accepted).filter(project_id=self.kwargs['pk']).distinct()
